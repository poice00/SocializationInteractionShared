...
<div class="tabbable" id="tabs-lectures">
	...
	<div class="tabbable" id="tabs-lectures">
					<ul class="nav nav-tabs">
						...
						<li class="active"><a data-toggle="tab" href="#panel-nl2">热门</a>
						</li>
						<li><a data-toggle="tab" href="#panel-hl2">最新</a></li>
					</ul>
					<div class="tab-content" style="height: 400px;">
						<div class="tab-pane active" id="panel-nl2">
						...
						<div class="tab-pane" id="panel-hl2">
							<s:iterator value="#new1list" status="activity">
								<div class="thumbnail" style="float:left; width: 240px; height: 370px;margin-top: 10px;margin-left: 20px;">
											<a href="activity_activityDetails.action?idd=${id}"><img
												src="${activityImg }" style="height: 200px; width: 220px;"/></a>
				...
				<div class="tabbable" id="tabs-lectures">
					<ul class="nav nav-tabs">
						...
						<li class="active"><a data-toggle="tab" href="#panel-nl3">热门</a>
						</li>
						<li><a data-toggle="tab" href="#panel-hl3">最新</a></li>
					</ul>
					<div class="tab-content" style="height: 400px;">
						<div class="tab-pane active" id="panel-nl3">
						...
						<div class="tab-pane" id="panel-hl3">
							<s:iterator value="#new2list" status="activity">
								<div class="thumbnail" style="float:left;width: 240px; height: 370px;margin-top: 10px;margin-left: 20px;">
											<a href="activity_activityDetails.action?idd=${id}"><img
												src="${activityImg }" style="height: 200px; width: 220px;"/></a>
				...
				<div class="tabbable" id="tabs-lectures">
					<ul class="nav nav-tabs">
						...
						<li class="active"><a data-toggle="tab" href="#panel-nl4">热门</a>
						</li>
						<li><a data-toggle="tab" href="#panel-hl4">最新</a></li>
					</ul>
					<div class="tab-content" style="height: 400px;">
						<div class="tab-pane active" id="panel-nl4">
						<s:iterator value="#hot2list" status="activity">
								<div class="thumbnail" style="float:left;width: 240px; height: 370px;margin-top: 10px;margin-left: 20px;">
											<a href="activity_activityDetails.action?idd=${id}"><img
												src="${activityImg }" style="height: 200px; width: 220px;"/></a>
						...
						<div class="tab-pane" id="panel-hl4">
							<s:iterator value="#new2list" status="activity">
								<div class="thumbnail" style="float:left;width: 240px; height: 370px;margin-top: 10px;margin-left: 20px;">
											<a href="activity_activityDetails.action?idd=${id}"><img
												src="${activityImg }" style="height: 200px; width: 220px;"/></a>
				...
				<div class="tabbable" id="tabs-lectures">
					<ul class="nav nav-tabs">
						...
						<li class="active"><a data-toggle="tab" href="#panel-nl5">热门</a>
						</li>
						<li><a data-toggle="tab" href="#panel-hl5">最新</a></li>
					</ul>
					<div class="tab-content" style="height: 400px;">
						<div class="tab-pane active" id="panel-nl5">
						<s:iterator value="#hot2list" status="activity">
								<div class="thumbnail" style="float:left;width: 240px; height: 370px;margin-top: 10px;margin-left: 20px;">
											<a href="activity_activityDetails.action?idd=${id}"><img
												src="${activityImg }" style="height: 200px; width: 220px;"/></a>
						...
						<div class="tab-pane" id="panel-hl5">
							<s:iterator value="#new2list" status="activity">
								<div class="thumbnail" style="float:left;width: 240px; height: 370px;margin-top: 10px;margin-left: 20px;">
											<a href="activity_activityDetails.action?idd=${id}"><img
												src="${activityImg }" style="height: 200px; width: 220px;"/></a>
				...
				<div class="tabbable" id="tabs-lectures">
					<ul class="nav nav-tabs">
						...
						<li class="active"><a data-toggle="tab" href="#panel-nl6">热门</a>
						</li>
						<li><a data-toggle="tab" href="#panel-hl6">最新</a></li>
					</ul>
					<div class="tab-content" style="height: 400px;">
						<div class="tab-pane active" id="panel-nl6">
						<s:iterator value="#hot2list" status="activity">
								<div class="thumbnail" style="float:left;width: 240px; height: 370px;margin-top: 10px;margin-left: 20px;">
											<a href="activity_activityDetails.action?idd=${id}"><img
												src="${activityImg }" style="height: 200px; width: 220px;"/></a>
						...
						<div class="tab-pane" id="panel-hl6">
							<s:iterator value="#new2list" status="activity">
								<div class="thumbnail" style="float:left; width: 240px; height: 370px;margin-top: 10px;margin-left: 20px;">
											<a href="activity_activityDetails.action?idd=${id}"><img
												src="${activityImg }" style="height: 200px; width: 220px;"/></a>
